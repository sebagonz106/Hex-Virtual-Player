...
Ambas estrategias se complementan con heurísticas de dominio específico que detectan patrones de conectividad relevantes en Hex. Se implementan técnicas de análisis de celdas inferiores (inferior cell analysis) para poda del árbol de búsqueda, incluyendo la detección de puentes, conexiones virtuales y patrones locales \cite{Arneson2010}. Los patrones explorados incluyen: (1) puentes y semi-conexiones virtuales para garantizar conectividad, (2) ziggurats como estructuras densas de piezas que facilitan conexiones de largo alcance \cite{Cazenave2009}, y (3) técnicas de relleno (fillin) para identificar celdas muertas y regiones capturadas \cite{Arneson2010}.
